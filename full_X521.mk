...
$(call inherit-product-if-exists, vendor/Infinix/X521/X521-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/Infinix/X521/overlay
PRODUCT_PACKAGE_OVERLAYS += device/Infinix/X521/overlay
...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_MODEL="Infinix HOT S"
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_BRAND=Infinix
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_DEVICE=Infinix-X521
